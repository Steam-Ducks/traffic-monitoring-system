...
|:--------:|:--------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------:|:----------:|:-------------:|:----------:|
|    1     |      Alta      | Como Administrador, quero que o sistema consulte os dados das cameras de transito em tempo real para que trabalhe sempre com os dados mais relevantes |        8         |     1      |      RF1      |     🔄     |
...
|    4     |     Média      | Como Gestor, quero acessar uma seção de indicadores detalhados que compõem a nota geral e local, para entender o que está impactando o nível          |        5         |     1      |      RF2      |     🔄     |
...
|    7     |     Média      | Como Administrador, quero cadastrar gestores locais no sistema e atribuí-los a regiões específicas para distribuir responsabilidades de monitoramento |        8         |     2      |      RF6      |     ❌      |
|    8     |     Média      | Como Administrador, quero configurar regras de alerta personalizadas por indicador e região para automatizar notificações críticas                    |        8         |     2      |      RF6      |     ❌      |
|    9     |     Média      | Como Gestor, quero visualizar facilmente se os indicadores estão melhorando / piorando em relação ao periodo anterior                                 |        5         |     3      |      RF4      |     ❌      |
|    10    |     Baixa      | Como Administrador, quero permitir a integração de dados externos para enriquecer análises com dados complementares                                   |        8         |     3      |      RF5      |     ❌      |
|    11    |     Baixa      | Como Cidadão, quero acessar um portal público com mapa simplificado e índice geral da cidade sem login para acompanhar a situação do tráfego          |        3         |     3      |      RF4      |     ❌      |
|    12    |     Baixa      | Como Administrador, quero gerenciar usuários do sistema (criar, editar, desativar) para controlar quem tem acesso às funcionalidades                  |        5         |     3      |      RF6      |     ❌      |
